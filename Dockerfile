...
RUN apk add --no-cache git python3 ca-certificates libffi-dev libssl1.0 libressl-dev && \
    ...
    pip3 install --no-cache-dir home-assistant-frontend sqlalchemy==1.2.2 python-miio==0.3.9 HAP-python==1.1.7 PyXiaomiGateway==0.8.3 distro==1.2.0 aiohttp_cors==0.6.0 jsonrpc-async==0.6 pychromecast==2.0.0 paho-mqtt==1.3.1 rxv==0.5.1 jsonrpc-websocket==0.6 websocket-client==0.37.0 && \

...
RUN apk add --no-cache git mariadb-connector-c-dev python3 autoconf nmap ca-certificates glib-dev libffi-dev jpeg-dev eudev-dev zlib-dev py3-lxml libssl1.0 libressl-dev && \
